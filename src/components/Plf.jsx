...
// const Plf = () => {
//   return (
//     <div className="flex flex-col md:flex-row items-center pt-16 md:pt-64 w-full  border border-gray-300 rounded-lg">
//       <div className="relative w-1/3 mx-4 md:ml-20 flex mb-8 md:mb-0">
//         <div className="relative">
//           <img src={backrect} alt="Background" className="w-full rounded-lg" style={{ position: 'relative', left: '20px', top: '20px', maxWidth: '300px', maxHeight: '300px' }} />
//           <img src={plfImage} alt="Law Firm" className="absolute top-0 left-0 w-full h-full rounded-lg" style={{ maxWidth: '800px', maxHeight: '400px' }} />
//         </div>
